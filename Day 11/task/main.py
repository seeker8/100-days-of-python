...
# def deal_cards(user_cards, computer_cards):
#     user_decision = input(prompt_message)
#     while(user_decision == "y" or user_score <21):
#         user_cards.append(random.choice(cards))
#         user_score = reduce(lambda x, y: x + y, user_cards)
#         print_hands()
#         if user_score < 21:
#             user_decision = input(prompt_continue)
#         else:
#             break
#
#     if user_score > 21:
...
# ask if user wants to play blackjack
# yes
    # print logo
    # print hands(user n computer)
